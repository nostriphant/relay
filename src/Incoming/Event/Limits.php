...
readonly class Limits {
    ...
    static function construct(
        ...
        if (isset($content_maxlength)) {
            ...
            if (count($content_maxlength) === 2) {
                ...
                $content_maxlength_check = fn(Event $event): bool => \nostriphant\Functional\Functions::in_range($event->kind, $content_maxlength[1], $content_maxlength[2]) && $content_maxlength_check($event);
            }
    ...
    static function fromEnv(): \nostriphant\Relay\Limits {
        return \nostriphant\Relay\Limits::fromEnv('EVENT', __CLASS__);
    }
